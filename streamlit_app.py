...
# --------------------------------------------------------------------
# LÓGICA PRINCIPAL POR RADIO (NO SE MEZCLAN RESULTADOS)
# --------------------------------------------------------------------
if opcion == "Porcentaje de diversidad":
    # --------------- UI + CÁLCULO DIVERSIDAD -----------------
...
"""
    ...
    # --------------- MOSTRAR RESULTADOS DIVERSIDAD (SOLO AQUÍ) ------
...
"""
    ...
    # --------------- MOSTRAR RESULTADOS ACCESIBILIDAD (SOLO AQUÍ) ---
    if (
